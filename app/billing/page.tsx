...
export default function BillingPage(){
  ...
  return <AppShell>
    <PageTitle title="การเงินและการชำระ" subtitle="สร้าง แก้ไข และลบใบแจ้งหนี้จาก Supabase" action={<button className="primary-btn" onClick={newInvoice} disabled={!visibleContracts.length}><Icon name="plus" size={18}/> สร้างใบแจ้งหนี้</button>}/>
