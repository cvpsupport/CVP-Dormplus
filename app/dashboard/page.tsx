  ...
  return <AppShell>
    ...
    {!workspace.activePropertyId ? <EmptyState title="ยังไม่มีโครงการ" description="ไปที่เมนูโครงการเพื่อสร้างโครงการแรก แล้วข้อมูล Dashboard จะอัปเดตอัตโนมัติ" action={<Link className="primary-btn" href="/projects"><Icon name="plus" size={17}/> สร้างโครงการ</Link>}/> : <>
      <section className="dashboard-hero">
        <div className="dashboard-hero-copy"><span className="hero-kicker"><Icon name="sparkles" size={15}/> LIVE PORTFOLIO</span><h2>ข้อมูลจริงจาก Supabase<br/><em>อัตราเข้าพัก {occupancy}%</em></h2><p>Dashboard นี้คำนวณจากห้อง ผู้เช่า ใบแจ้งหนี้ และงานซ่อมของโครงการปัจจุบัน</p><div className="hero-actions"><Link href="/meters" className="hero-primary"><Icon name="meter" size={16}/> จดมิเตอร์น้ำ / ไฟ</Link><Link href="/billing" className="hero-secondary"><Icon name="receipt" size={15}/> ดูการเงิน</Link><Link href="/rooms" className="hero-secondary">ดูสถานะห้อง <Icon name="chevron" size={15}/></Link></div></div>
