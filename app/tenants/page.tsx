...
export default function TenantsPage(){
  ...
  return <AppShell>
    <PageTitle title="ผู้เช่า" subtitle={workspace.activeProperty?`จัดการผู้เช่าของ ${workspace.activeProperty.name}`:'สร้างโครงการก่อนเพิ่มผู้เช่า'} action={workspace.can('tenants.create')?<button className="primary-btn" onClick={createNew} disabled={!workspace.activePropertyId}><Icon name="plus" size={18}/> เพิ่มผู้เช่า</button>:undefined}/>
